...
import {
  ThemeContext,
  TTheme,
} from 'auth-frontend/components/ThemeProvider/hooks/useTheme';

const LightTheme = lazy(
  () => import('auth-frontend/components/ThemeProvider/Themes/LightTheme'),
);
const DarkTheme = lazy(
  () => import('auth-frontend/components/ThemeProvider/Themes/DarkTheme'),
);
